...
function renderSolicitudes(lista) {
  ...
  lista.forEach((solicitud) => {
    ...
    card.innerHTML = `
      ...
      <p class="info-line"><strong>Precio:</strong> ${formatearDinero(solicitud.precio || 100)}</p>
      <p class="info-line"><strong>Cobro:</strong> El alumno podrá pagar cuando aceptes la solicitud.</p>
