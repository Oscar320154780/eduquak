...
/*
  SEED REALISTA EDUQUAK - 3 MESES
  Archivo sugerido dentro del proyecto:
  backend/src/scripts/seed-realista-3meses.js

  Requisitos:
  - DATABASE_URL en backend/.env
  - CLOUDINARY_CLOUD_NAME, CLOUDINARY_API_KEY, CLOUDINARY_API_SECRET en backend/.env
  - npm install ya debe tener: pg, bcryptjs, cloudinary, dotenv

  Uso:
  npm run seed-realista

  Opcional:
  RESET_DEMO=true npm run seed-realista
*/
